...
$g5['title'] = '매체/월별 현황(회계)';
$g5['title_desc'] ='<p>① 매체별 매출 금액 표기 : 자사미디어 </p>
<p>② 매체별 매출 금액 (매출 - 매입) 표기 : 자사미디어 제외(제작대행,설치대행,영업수수료,종합대행, 방송대행,옥외대행,디지털대행,인쇄대행 ,기타서비스 ) </p>
<p class="txt_true"> *매출 : 계약의 매체 매출금액, 매입 : 계약의 정산 매입 금액(제작비 제외) </p>' ;
        ...
        var source =
            {
                ...
                url: g_sale_url+'/report/report_media_ym_01_result.php',
                cache: false,
        ...
        $("#grid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '판매방식', datafield: 'cont_sale_type_nm', filtertype: 'checkedlist', cellsalign: 'center', align: 'center'  ,width:100  },
