        ...
        var source =
            {
                ...
                url: g_sale_url+'/inven_list_mda_result.php',
                cache: false,
        ...
        $("#grid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '매체', datafield: 'm2_nm', columngroup: 'mdaGroup', filtertype: 'checkedlist',  align: 'center' ,width:120  },
                    { text: '상품', datafield: 'm3_nm', columngroup: 'mdaGroup', filtertype: 'checkedlist',  align: 'center'  ,width:120 },
                <!--    { text: '매체', datafield: 'm4_nm', filtertype: 'checkedlist',  align: 'center' ,width:100  },-->
