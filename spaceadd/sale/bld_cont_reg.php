        ...
        $("#grid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '기기초수', datafield: 'ins_sec', filtertype: 'checkedlist', cellsalign: 'center', align: 'center'  ,width:100},
                    { text: '기기수', datafield: 'ins_cnt', filtertype: 'checkedlist', cellsalign: 'center', align: 'center'  ,width:100,  editable: false },
                    ...
                    { text: '금지업종', datafield: 'excpt_item', filtertype: 'checkedlist', cellsalign: 'center', align: 'center'  ,width:100},
        ...
        $("#grid_cont").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '판매구분', datafield: 'cont_sale_type_nm', filtertype: 'checkedlist' , cellsalign: 'center', align: 'center'  ,width:100},
...
<div>
    <form id="fsearch0" name="fsearch0" class="local_sch01 local_sch" method="get">
        <strong>소재초수</strong>
        <input type="hidden" name="bld_req_type"  id="bld_req_type" value="bld_seq">
    ...
    <div id="main_grid0"   style="display:flex; ">
        <div id="div01" class="" style="width: 100%; height: 500px;padding:3px">
            <div class="pad-b-15"><div class="subTlt"  >빌딩정보</div></div>
              <div>
...
<!--                    <div style="display:none">
                    ...
                    <input type="text" name="search_str" value="<?php /*echo $search_str */?>" id="search_str" required class="frm_input">
                    </div>-->
        ...
        <div id="div02" class="" style="width: 100%; height:400px;padding:3px">
