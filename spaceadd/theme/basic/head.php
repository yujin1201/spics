...
//include_once(G5_THEME_PATH.'/jPushMenu/jPushMenu.php');
...
<script type="text/javascript" src="/spaceadd/sale/js/comm.js"></script>
...
<header id="hd">
    ...
    <div id="hd_top">
       ...
       <div id="logo"><a href="<?php echo correct_goto_url(G5_SALE_URL); ?>"><img src="<?php echo G5_SALE_URL ?>/img/logo_spa_w.png" width="150px"></a></div>
        <div id="tnb">
            <ul>
                <li class="tnb_li"><a href="<?php echo G5_URL ?>/" class="tnb_community" target="_blank" title="커뮤니티 바로가기">커뮤니티 바로가기</a></li>
                <li class="tnb_li"><a href="<?php echo G5_SALE_URL ?>/comp_list.php" class="tnb_service">스패이스애드</a></li>
