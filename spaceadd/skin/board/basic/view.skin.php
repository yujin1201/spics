    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
                ...
                <strong class="if_date"><span class="sound_only">수정일</span><i class="fa fa-clock-o" aria-hidden="true"></i>마지막 수정일  <?php echo date("y-m-d H:i", strtotime($view['wr_last'])) ?></strong>
    		</div>
    	</div>
